...
#define STREAM_BUFFER_WIDTH	1280
#define STREAM_BUFFER_HEIGHT	720
...
struct instance {
	...
	struct {
		...
		int timeout;
		/* Record encoded yuv frames into output_filename */
	...
	int finish;		/* Flag set when encoding has been completed and all
				   threads finish */
	int encoded_cnt;	/* Total encoded frames count */
	bool is_hdmi;
};
